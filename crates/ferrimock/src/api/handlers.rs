...
/// Delete mock(s)
///
/// DELETE /__ferrimock/mocks/:id
/// DELETE /__ferrimock/mocks?scope=test-*
/// DELETE /__ferrimock/mocks?filter=priority<50
...
/// Get mock(s)
///
/// GET /__ferrimock/mocks/:id
/// GET /__ferrimock/mocks
/// GET /__ferrimock/mocks?filter=enabled=true&priority>100
/// GET /__ferrimock/mocks?scope=integration-test
