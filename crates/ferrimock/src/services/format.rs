...
pub fn format_path(input: FormatInput) -> Result<FormatOutput, crate::FerrimockError> {
...
#[allow(clippy::needless_pass_by_value)] // owned input is the service API boundary
pub fn format_content(input: FormatContentInput) -> Result<String, crate::FerrimockError> {
...
fn collect_mock_files(dir: &Path) -> Result<Vec<PathBuf>, crate::FerrimockError> {
...
fn format_single_file(path: &Path, check: bool) -> Result<bool, crate::FerrimockError> {
...
fn format_json(content: &str) -> Result<String, crate::FerrimockError> {
...
fn expand_json_body_strings(json_str: &str) -> Result<String, crate::FerrimockError> {
