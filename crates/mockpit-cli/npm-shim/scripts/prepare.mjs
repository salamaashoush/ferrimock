...
// cli-npm-<rust-triple> containing the raw binary (mockpit or
// mockpit.exe), as uploaded by the release workflow's build-cli job.
...
const TARGETS = {
  ...
  "x86_64-unknown-linux-musl": {
    dir: "linux-x64-musl",
    name: "@mockpit/cli-linux-x64-musl",
    os: "linux",
    cpu: "x64",
    binary: "mockpit",
  },
  "aarch64-unknown-linux-musl": {
    ...
    name: "@mockpit/cli-linux-arm64-musl",
    os: "linux",
    cpu: "arm64",
    binary: "mockpit",
  },
    ...
    JSON.stringify(
      {
        name: target.name,
        version,
        description: `Mockpit CLI native binary for ${target.os}-${target.cpu}`,
        license: "MIT OR Apache-2.0",
        repository: {
          type: "git",
          url: "git+https://github.com/salamaashoush/mockpit.git",
        },
        os: [target.os],
        cpu: [target.cpu],
        files: [target.binary],
