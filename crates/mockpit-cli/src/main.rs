...
#[command(
    ...
    long_about = "Mockpit is a high-performance HTTP mocking framework.\n\n\
    ...
    styles = get_styles(),
    after_help = "Use 'mockpit <command> --help' for more information about a specific command.\n\
        Documentation: https://github.com/salamaashoush/mockpit"
)]
struct Cli {
    #[command(subcommand)]
    command: Command,
