...
//! The actual fake data generators are in the fake-data crate.
...
pub fn register_all_functions(tera: &mut tera::Tera) {
  ...
  tera.register_function("uuid", |_args: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(Uuid::new_v4().to_string()))
  });

  // ========== Identity & Personal Data ==========
  tera.register_function("fake_name", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identity::fake_name()))
  });

  tera.register_function("fake_first_name", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identity::fake_first_name()))
  });

  tera.register_function("fake_last_name", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identity::fake_last_name()))
  });

  tera.register_function("fake_username", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identity::fake_username()))
  });

  tera.register_function("fake_password", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identity::fake_password()))
  });

  tera.register_function("fake_title", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identity::fake_title()))
  });

  tera.register_function("fake_suffix", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identity::fake_suffix()))
  });

  // ========== Contact Information ==========
  tera.register_function("fake_email", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::contact::fake_email()))
  });

  tera.register_function("fake_free_email", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::contact::fake_free_email()))
  });

  tera.register_function("fake_phone", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::contact::fake_phone()))
  });

  tera.register_function("fake_cell_phone", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::contact::fake_cell_phone()))
  });

  // ========== Location & Address ==========
  tera.register_function("fake_street", |_: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function(
    ...
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::location::fake_street_address()))
    },
  );

  tera.register_function("fake_city", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::location::fake_city()))
  });

  tera.register_function("fake_state", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::location::fake_state()))
  });

  tera.register_function("fake_state_abbr", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::location::fake_state_abbr()))
  });

  tera.register_function("fake_zip", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::location::fake_zip()))
  });

  tera.register_function("fake_country", |_: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function(
    "fake_country_code",
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::location::fake_country_code()))
    },
  );

  tera.register_function("fake_latitude", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::location::fake_latitude()))
  });

  tera.register_function("fake_longitude", |_: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function(
    "fake_postal_code",
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::location::fake_postal_code()))
    },
  );
  ...
  tera.register_function(
    ...
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::location::fake_building_number()))
    },
  );
  ...
  tera.register_function(
    ...
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::location::fake_secondary_address()))
    },
  );

  // ========== Company & Job ==========
  tera.register_function("fake_company", |_: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function(
    "fake_company_suffix",
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::company::fake_company_suffix()))
    },
  );

  tera.register_function("fake_job_title", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::company::fake_job_title()))
  });

  tera.register_function("fake_industry", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::company::fake_industry()))
  });

  tera.register_function("fake_job_field", |_: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function(
    "fake_job_position",
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::company::fake_job_position()))
    },
  );
  ...
  tera.register_function(
    "fake_job_seniority",
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::company::fake_job_seniority()))
    },
  );

  // ========== Internet & Networking ==========
  tera.register_function("fake_url", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::internet::fake_url()))
  });

  tera.register_function("fake_domain", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::internet::fake_domain()))
  });

  tera.register_function("fake_ipv4", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::internet::fake_ipv4()))
  });

  tera.register_function("fake_ipv6", |_: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function(
    "fake_mac_address",
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::internet::fake_mac_address()))
    },
  );

  tera.register_function("fake_user_agent", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::internet::fake_user_agent()))
  });

  tera.register_function("fake_color", |_: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function(
    "fake_pagination_url",
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::internet::fake_pagination_url()))
    },
  );
  ...
  tera.register_function(
    ...
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::internet::fake_pagination_url_offset()))
    },
  );

  tera.register_function("fake_search_url", |_: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function(
    ...
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::internet::fake_file_download_url()))
    },
  );

  tera.register_function("fake_api_url", |_: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function(
    "fake_webhook_url",
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::internet::fake_webhook_url()))
    },
  );
  ...
  tera.register_function(
    "fake_api_endpoint",
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::internet::fake_api_endpoint()))
    },
  );
  ...
  tera.register_function(
    "fake_resource_path",
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::internet::fake_resource_path()))
    },
  );
  ...
  tera.register_function(
    ...
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::internet::fake_user_agent_modern()))
    },
  );

  // ========== Text & Content ==========
  tera.register_function("fake_words", |args: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function(
    ...
    |args: &HashMap<String, Value>| -> tera::Result<Value> {
      ...
      Ok(Value::String(mockpit_fake_data::text::fake_sentence(word_count)))
    },
  );
  ...
  tera.register_function(
    "fake_paragraph",
    |args: &HashMap<String, Value>| -> tera::Result<Value> {
      let sentence_count = args.get("sentence_count").and_then(|v| v.as_u64()).unwrap_or(3) as usize;
      Ok(Value::String(mockpit_fake_data::text::fake_paragraph(sentence_count)))
    },
  );

  tera.register_function("fake_word", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::text::fake_word()))
  });

  tera.register_function("fake_slug", |_: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function(
    ...
    |args: &HashMap<String, Value>| -> tera::Result<Value> {
      ...
      Ok(Value::String(mockpit_fake_data::text::fake_alphanumeric(length)))
    },
  );
  ...
  tera.register_function(
    "fake_currency_code",
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::finance::fake_currency_code()))
    },
  );
  ...
  tera.register_function(
    "fake_currency_name",
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::finance::fake_currency_name()))
    },
  );
  ...
  tera.register_function(
    ...
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::finance::fake_currency_symbol()))
    },
  );

  tera.register_function("fake_price", |args: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function("fake_amount", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::finance::fake_amount()))
  });

  // ========== Identifiers & Codes ==========
  tera.register_function("fake_uuid", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identifiers::fake_uuid()))
  });

  tera.register_function("fake_isbn", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identifiers::fake_isbn()))
  });

  tera.register_function("fake_isbn13", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identifiers::fake_isbn13()))
  });

  tera.register_function("fake_token", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identifiers::fake_token()))
  });

  tera.register_function("fake_etag", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identifiers::fake_etag()))
  });

  tera.register_function("fake_numeric_id", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identifiers::fake_numeric_id()))
  });

  tera.register_function("fake_short_hash", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identifiers::fake_short_hash()))
  });

  tera.register_function("fake_sha256", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identifiers::fake_sha256()))
  });

  tera.register_function("fake_md5", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identifiers::fake_md5()))
  });

  tera.register_function("fake_base64", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identifiers::fake_base64()))
  });

  tera.register_function("fake_jwt", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::identifiers::fake_jwt()))
  });

  // ========== Dates & Times ==========
  tera.register_function("fake_date", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::datetime::fake_date()))
  });

  tera.register_function("fake_time", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::datetime::fake_time()))
  });

  tera.register_function("fake_iso_date", |_: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function(
    "fake_unix_timestamp",
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::Number(mockpit_fake_data::datetime::fake_unix_timestamp().into()))
    },
  );
  ...
  tera.register_function(
    "fake_relative_time",
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::datetime::fake_relative_time()))
    },
  );

  // ========== Web-Specific ==========
  tera.register_function("fake_boolean", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::Bool(mockpit_fake_data::web::fake_boolean()))
  });

  tera.register_function("fake_filename", |_: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function(
    ...
    |args: &HashMap<String, Value>| -> tera::Result<Value> {
      ...
      Ok(Value::Number(mockpit_fake_data::web::fake_file_size(min, max).into()))
    },
  );

  tera.register_function(
    "fake_download_url",
    |_: &HashMap<String, Value>| -> tera::Result<Value> { Ok(Value::String(mockpit_fake_data::web::fake_download_url())) },
  );

  tera.register_function("fake_mime_type", |_: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function(
    "fake_api_version",
    |_: &HashMap<String, Value>| -> tera::Result<Value> { Ok(Value::String(mockpit_fake_data::web::fake_api_version())) },
  );

  tera.register_function("fake_version", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::web::fake_version()))
  });

  tera.register_function("fake_hex_color", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::web::fake_hex_color()))
  });

  tera.register_function("fake_rgb_color", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::web::fake_rgb_color()))
  });

  tera.register_function("fake_locale", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::web::fake_locale()))
  });

  tera.register_function("fake_timezone", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::String(mockpit_fake_data::web::fake_timezone()))
  });

  tera.register_function("fake_semver", |_: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function(
    ...
    |_: &HashMap<String, Value>| -> tera::Result<Value> {
      Ok(Value::String(mockpit_fake_data::web::fake_semver_prerelease()))
    },
  );

  tera.register_function("fake_digit", |_: &HashMap<String, Value>| -> tera::Result<Value> {
    Ok(Value::Number(mockpit_fake_data::web::fake_digit().into()))
  });

  tera.register_function("fake_number", |args: &HashMap<String, Value>| -> tera::Result<Value> {
    let min = args.get("min").and_then(|v| v.as_i64()).unwrap_or(1);
    let max = args.get("max").and_then(|v| v.as_i64()).unwrap_or(1000);
    Ok(Value::Number(mockpit_fake_data::web::fake_number(min, max).into()))
  });

  tera.register_function("fake_float", |args: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function("fake_pdf", |args: &HashMap<String, Value>| -> tera::Result<Value> {
    let text = args.get("text").and_then(|v| v.as_str());
    let pages = args.get("pages").and_then(|v| v.as_u64()).map(|v| v as u32);
    Ok(Value::String(mockpit_fake_data::files::fake_pdf(text, pages)))
  });

  tera.register_function("fake_png", |args: &HashMap<String, Value>| -> tera::Result<Value> {
    ...
    Ok(Value::String(mockpit_fake_data::files::fake_png(width, height, color)))
  });

  tera.register_function("fake_jpeg", |args: &HashMap<String, Value>| -> tera::Result<Value> {
    let width = args.get("width").and_then(|v| v.as_u64()).map(|v| v as u32);
    let height = args.get("height").and_then(|v| v.as_u64()).map(|v| v as u32);
    let color = args.get("color").and_then(|v| v.as_str());
    let quality = args.get("quality").and_then(|v| v.as_u64()).map(|v| v as u8);
  ...
  tera.register_function(
    ...
    |args: &HashMap<String, Value>| -> tera::Result<Value> {
      let text = args.get("text").and_then(|v| v.as_str());
      let pages = args.get("pages").and_then(|v| v.as_u64()).map(|v| v as u32);
      Ok(Value::String(mockpit_fake_data::files::fake_pdf_data_uri(text, pages)))
    },
  );
  ...
  tera.register_function(
    ...
    |args: &HashMap<String, Value>| -> tera::Result<Value> {
      ...
      Ok(Value::String(mockpit_fake_data::files::fake_image_with_text(
  ...
  tera.register_function(
    ...
    |args: &HashMap<String, Value>| -> tera::Result<Value> {
      ...
      Ok(Value::String(mockpit_fake_data::files::fake_image_gradient(
        width,
        height,
        start_color,
        end_color,
  ...
  tera.register_function(
    ...
    |args: &HashMap<String, Value>| -> tera::Result<Value> {
      ...
      let square_size = args.get("square_size").and_then(|v| v.as_u64()).map(|v| v as u32);
      Ok(Value::String(mockpit_fake_data::files::fake_image_checkerboard(
        width,
        height,
        color1,
        color2,
  ...
  tera.register_function(
    ...
    |args: &HashMap<String, Value>| -> tera::Result<Value> {
      ...
      let color1 = args.get("color1").and_then(|v| v.as_str());
      let color2 = args.get("color2").and_then(|v| v.as_str());
      let stripe_width = args.get("stripe_width").and_then(|v| v.as_u64()).map(|v| v as u32);
      let direction = args.get("direction").and_then(|v| v.as_str());
  ...
  tera.register_function("fake_avatar", |args: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function("now_plus", |args: &HashMap<String, Value>| -> tera::Result<Value> {
  ...
  tera.register_function("now_minus", |args: &HashMap<String, Value>| -> tera::Result<Value> {
    let days = args.get("days").and_then(|v| v.as_i64()).unwrap_or(0);
    let hours = args.get("hours").and_then(|v| v.as_i64()).unwrap_or(0);
    let minutes = args.get("minutes").and_then(|v| v.as_i64()).unwrap_or(0);
    let seconds = args.get("seconds").and_then(|v| v.as_i64()).unwrap_or(0);
  ...
  //
  // These functions construct URLs to the built-in file service at /__internal_gateway_files/
  // for use in mock templates. They accept the same params as the HTTP endpoints.

  // mock_pdf_url(text="...", pages=2, filename="doc.pdf", id="...")
  //   -> "/__internal_gateway_files/pdf/{id}?text=...&pages=2&filename=doc.pdf"
  tera.register_function("mock_pdf_url", |args: &HashMap<String, Value>| -> tera::Result<Value> {
    let id = args
      .get("id")
      .and_then(|v| v.as_str())
      .map(|s| s.to_string())
    ...
    Ok(Value::String(format!("/__internal_gateway_files/pdf/{}{}", id, query)))
  });

  // mock_image_url(width=800, height=600, type="placeholder", text="...", format="png", id="...")
  //   -> "/__internal_gateway_files/image/{id}?width=800&height=600&type=placeholder&text=..."
  tera.register_function(
    "mock_image_url",
    |args: &HashMap<String, Value>| -> tera::Result<Value> {
      let id = args
      ...
      Ok(Value::String(format!("/__internal_gateway_files/image/{}{}", id, query)))
    },
  );

  // mock_avatar_url(initials="SA", size=200, bg="#FF6B6B", fg="#FFFFFF", id="...")
  //   -> "/__internal_gateway_files/avatar/{id}?initials=SA&size=200&bg=%23FF6B6B"
  tera.register_function(
    "mock_avatar_url",
    |args: &HashMap<String, Value>| -> tera::Result<Value> {
      let id = args
      ...
      Ok(Value::String(format!("/__internal_gateway_files/avatar/{}{}", id, query)))
    },
  );

  // mock_font_url(family="DejaVuSans")
  //   -> "/__internal_gateway_files/font?family=DejaVuSans"
  tera.register_function(
    "mock_font_url",
    |args: &HashMap<String, Value>| -> tera::Result<Value> {
      let mut params = Vec::new();
      ...
      Ok(Value::String(format!("/__internal_gateway_files/font{}", query)))
    },
  );
  ...
  tera.register_function("fake_array", |args: &HashMap<String, Value>| -> tera::Result<Value> {
    let data_type = args
      .get("type")
      .and_then(|v| v.as_str())
