...
pub fn register_all_functions(tera: &mut tera::Tera) {
  ...
  tera.register_function("mock_pdf_url", |args: &HashMap<String, Value>| -> tera::Result<Value> {
    ...
    Ok(Value::String(format!("/__box_dev_gate_files/pdf/{}{}", id, query)))
  });
  ...
  tera.register_function(
    ...
    |args: &HashMap<String, Value>| -> tera::Result<Value> {
      ...
      Ok(Value::String(format!("/__box_dev_gate_files/image/{}{}", id, query)))
    },
  );
  ...
  tera.register_function(
    ...
    |args: &HashMap<String, Value>| -> tera::Result<Value> {
      ...
      Ok(Value::String(format!("/__box_dev_gate_files/avatar/{}{}", id, query)))
    },
  );
