...
pub fn fake_image(input: JsFakeImageInput) -> Result<JsFakeImageResult> {
    let defaults = ferrimock::services::fake_image::FakeImageInput::default();
    let result = ferrimock::services::fake_image::generate(
        ferrimock::services::fake_image::FakeImageInput {
