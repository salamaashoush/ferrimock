...
pub fn fake_data(input: JsFakeDataInput) -> Result<Vec<String>> {
    ferrimock::services::fake_data::generate(ferrimock::services::fake_data::FakeDataInput {
...
pub fn list_generators(category: Option<String>, search: Option<String>) -> Vec<JsGeneratorInfo> {
    ferrimock::services::fake_data::list_generators(category.as_deref(), search.as_deref())
        .into_iter()
