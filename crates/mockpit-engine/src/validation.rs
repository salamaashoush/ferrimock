...
impl MockValidator {
    ...
    fn body_matchers_discriminate(
        body1: &mockpit_types::BodyMatcher,
        body2: &mockpit_types::BodyMatcher,
    ) -> bool {
            ...
            for h2 in headers2 {
                if h1.name == h2.name {
                    match (&h1.pattern, &h2.pattern) {
                        (
                            mockpit_types::HeaderMatchPattern::Exact(v1),
                            mockpit_types::HeaderMatchPattern::Exact(v2),
                        ) if v1 != v2 => {
                            return true;
                        }
                        (
                            mockpit_types::HeaderMatchPattern::Exact(_),
                            mockpit_types::HeaderMatchPattern::Exact(_),
                        ) => {}
                        (
                            mockpit_types::HeaderMatchPattern::Present,
                            mockpit_types::HeaderMatchPattern::Absent,
                        )
                        | (
                            mockpit_types::HeaderMatchPattern::Absent,
                            mockpit_types::HeaderMatchPattern::Present,
            ...
            for q2 in queries2 {
                if q1.name == q2.name {
                    match (&q1.pattern, &q2.pattern) {
                        (
                            mockpit_types::QueryMatchPattern::Exact(v1),
                            mockpit_types::QueryMatchPattern::Exact(v2),
                        ) if v1 != v2 => {
                            return true;
                        }
                        (
                            mockpit_types::QueryMatchPattern::Exact(_),
                            mockpit_types::QueryMatchPattern::Exact(_),
                        ) => {}
                        (
                            mockpit_types::QueryMatchPattern::Present,
                            mockpit_types::QueryMatchPattern::Absent,
                        )
                        | (
                            mockpit_types::QueryMatchPattern::Absent,
                            mockpit_types::QueryMatchPattern::Present,
