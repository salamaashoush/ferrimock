...
use mockpit_engine::{
  BodyMatcher, BodySource, HeaderMatcher, MockDefinition, MockMatcher, MockRegistry, QueryMatcher, RequestMatcher,
...
fn test_mock_with_regex_pattern() {
  ...
  assert!(
    matcher
      .find_match(&Method::GET, "/api/2.0/files/123/content", None, &headers, None)
      .is_none()
  );
}
...
fn test_mock_with_header_matching() {
  ...
  let mock = MockDefinition {
    ...
    request: RequestMatcher {
      ...
      header_matchers: smallvec![HeaderMatcher::present(HeaderName::from_static("authorization"))],
      body_matcher: None,
      graphql_matcher: None,
      query_matchers: smallvec![],
    },
    response: ResponseGenerator::new(StatusCode::OK, BodySource::inline(r#"{"authorized":true}"#)),
    vars: None,
  };
  ...
  assert!(
    matcher
      .find_match(&Method::GET, "/api/2.0/protected", None, &headers_with_auth, None)
      .is_some()
  );
  ...
  assert!(
    matcher
      .find_match(&Method::GET, "/api/2.0/protected", None, &headers_no_auth, None)
      .is_none()
  );
}
...
fn test_body_matcher_contains() {
  use mockpit_engine::BodyMatcher;
...
fn test_mock_with_body_matcher() {
  ...
  let mock = MockDefinition {
    ...
    response: ResponseGenerator::new(StatusCode::OK, BodySource::inline(r#"{"matched": true}"#)),
    vars: None,
  };
...
fn test_mock_with_conditions() {
  ...
  let mock = MockDefinition {
    ...
    response: ResponseGenerator::new(StatusCode::OK, BodySource::inline(r#"{"filtered": true}"#)),
    vars: None,
  };
...
fn test_glob_pattern_matching() {
  ...
  let mock = MockDefinition {
    ...
    response: ResponseGenerator::new(StatusCode::OK, BodySource::inline(r#"{"matched": "glob"}"#)),
    vars: None,
  };
  ...
  assert!(
    matcher
      .find_match(&Method::GET, "/api/v2/files/document.pdf", None, &headers, None)
      .is_some()
  );
...
fn test_complex_conditional_matching() {
  ...
  let admin_mock = MockDefinition {
    ...
    request: RequestMatcher {
      ...
      header_matchers: smallvec![HeaderMatcher::present(HeaderName::from_static("authorization"))],
      body_matcher: Some(BodyMatcher::json_path("user.role", serde_json::json!("admin"))),
      query_matchers: smallvec![QueryMatcher::exact("confirmed", "true")],
      graphql_matcher: None,
    },
    response: ResponseGenerator::new(StatusCode::OK, BodySource::inline(r#"{"admin_action": "executed"}"#)),
    vars: None,
  };
...
fn test_complex_priority_matching() {
  ...
  registry.add_mock(MockDefinition {
    ...
    response: ResponseGenerator::new(StatusCode::OK, BodySource::inline(r#"{"priority": "low"}"#)),
    vars: None,
  });
  ...
  registry.add_mock(MockDefinition {
    ...
    response: ResponseGenerator::new(StatusCode::OK, BodySource::inline(r#"{"priority": "medium"}"#)),
    vars: None,
  });
  ...
  registry.add_mock(MockDefinition {
    ...
    response: ResponseGenerator::new(StatusCode::OK, BodySource::inline(r#"{"priority": "high"}"#)),
    vars: None,
  });
