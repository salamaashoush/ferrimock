...
mod tests {
  ...
  fn test_box_file_object_with_pdf_download_url() {
    ...
    let sign_object = FieldType::Object(Box::new(mockpit_type_detector::ObjectAnalysis {
      varying_fields: vec![(
        ...
        FieldType::DownloadUrl {
          sample_url: Some("https://dl.boxcloud.com/d/1/b0!6mFruo9M1-NhU-3a1Ou3mh...".to_string()),
        },
      )],
      constant_fields: vec![(
    ...
    let template = generator.generate_tera_template(&analysis, "/app-api/sign-web/file-info", &graphql_analysis);
  ...
  fn test_box_file_object_with_png_download_url() {
    ...
    let graphql_analysis = crate::types::GraphQLVariableInfo::empty();
    let template = generator.generate_tera_template(&analysis, "/app-api/files", &graphql_analysis);
