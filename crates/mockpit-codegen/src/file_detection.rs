...
use crate::types::ResponseStructure;
use mockpit_type_detector::ObjectAnalysis;
...
pub(super) fn extract_file_extension(analysis: &ObjectAnalysis, parent_extension: Option<&str>) -> Option<String> {
  // Check if this is a Box file object (has type: "file")
  let is_file_object = analysis
    .constant_fields
    .iter()
